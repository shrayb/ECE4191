...
class Robot:
    ...
    def follow_path(self):
        ...
        while True:
            ...
            if waypoint_error_distance < 0.03 and waypoint_error_angle < (2 * math.pi / 180) and not self.is_impending_collision:  # 3 cm accuracy and 5 degree accuracy
                self.current_goal = None
                self.max_tick_factor = 1
            elif waypoint_error_distance < 0.03 and waypoint_error_angle >= (2 * math.pi / 180) and not self.is_impending_collision:
