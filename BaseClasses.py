...
class Package:
    ...
    def identify_destinations(self):
        if self.colour == "red":
            self.destination_pose = Pose(x=0.2, y=0.9, theta=math.pi/2)
...
class ColourSensor:
    def __init__(self, s2=None, s3=None, signal=None):
        ...
        self.ranges = [[28491.206614350063, 21726.55114793839, 28027.030273259938], [27245.580278715977, 28760.907287754515, 21850.31818981723], [20236.410029393126, 23108.166259080594, 23258.45381975142]]  # R G B
