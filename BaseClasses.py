...
class Package:
    ...
    def identify_destinations(self):
        if self.colour == "red":
            ...
            self.return_destination = Pose(x=0.3, y=0.2)
...
class ColourSensor:
    def __init__(self, s2=None, s3=None, signal=None):
        ...
        self.ranges = [[29275.21573557254, 19274.232019588388, 24644.405056624586], [19360.048481666363, 22601.722078793402, 27481.36710643544], [15514.707682439386, 19976.886310934828, 23994.79197390303]]  # R G B
